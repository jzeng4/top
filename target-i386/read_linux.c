...
#if 0
uint32_t PEMU_hookingpoint = 0;
uint32_t PEMU_hookingpoint2 = 0;
uint32_t PEMU_taskaddr = 0;
int PEMU_tasksize = 0;
int PEMU_listoffset = 0;
int PEMU_pidoffset = 0;
int PEMU_mmoffset = 0;
int PEMU_pgdoffset = 0;
int PEMU_commoffset = 0;
int PEMU_commsize = 0;
int PEMU_vmstartoffset = 0;
int PEMU_vmendoffset = 0;
int PEMU_vmnextoffset = 0;
int PEMU_vmfileoffset = 0;
int PEMU_dentryoffset = 0;
int PEMU_dnameoffset = 0;
int PEMU_dinameoffset = 0;
#endif
...
uint32_t next_task_struct(uint32_t addr)
{
  ...
  if (0xC031E000 == taskaddr)
    ...
    TEMU_read_mem(addr + listoffset + sizeof(uint32_t), 
...
//	fprintf(stderr, "init_kernel_offsets:\t%x\n", hookingpoint);
